...
export class ListProductQueryDto {
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Ordenação no formato campo:direcao. Campos: id,name,price,categoryId,createdAt,updatedAt. Direção: asc|desc',
  })
  sort_by?: string;
  ...
  @ApiPropertyOptional({
    example: 'RGB',
    description: 'Filtro por descrição (busca parcial, case-insensitive)',
  })
  description?: string;
  ...
  @ApiPropertyOptional({
    example: 50,
    description: 'Filtro por preço mínimo',
  })
  price_gte?: string;

  @ApiPropertyOptional({
    example: 500,
    description: 'Filtro por preço máximo',
  })
  price_lte?: string;

  @ApiPropertyOptional({
    example: '50,500',
    description: 'Filtro por faixa de preço no formato minimo,maximo',
  })
  price_between?: string;
